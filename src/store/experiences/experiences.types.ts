...
export const UPLOAD_EXPERIENCE_START = 'UPLOAD_EXPERIENCE_START';
export const UPLOAD_EXPERIENCE_SUCCESS = 'UPLOAD_EXPERIENCE_SUCCESS';
export const UPLOAD_EXPERIENCE_FAILURE = 'UPLOAD_EXPERIENCE_FAILURE';
