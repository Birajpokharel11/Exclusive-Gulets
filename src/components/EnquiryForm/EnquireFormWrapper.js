...
function EnquireFormWrapper({ smallContainerWidth, maxToScroll }) {
   ...
   return (
      <div style={windowWidth <= 992 ? { display: 'none' } : null} className="col-lg-4 d-lg-block sticky_block">
         <div className="form_container">
            ...
            <EnquireForm smallContainerWidth={smallContainerWidth} /*afterSend={afterSend}*/ />
            {/* </> */}
            {/* } */}
         </div>
      </div>
