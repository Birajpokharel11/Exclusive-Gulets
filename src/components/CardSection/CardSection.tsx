...
function CardSection({
  ...
  return (
    <section
      ...
      className="home-newsAndBlogs"
      hidden={false}
    >
      <div className="container-lg p-mob-0">
        <div className="d-flex justify-content-center p-mob-15">
          <h2 className={`section-title text-center stripped`}>{title}</h2>
        </div>

        <p className={`section-paragraph text-center p-mob-15`}>{subtitle}</p>
        ...
        <div className="section-button-indent p-mob-15">
          <div className="d-flex justify-content-center">
            <Link
              className="btn-theme-common btn-theme-filled--blue sm-wide"
              to={`/blogs`}
            >
              See All News & Blogs
            </Link>
